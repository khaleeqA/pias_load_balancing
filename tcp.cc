...
TcpAgent::TcpAgent()
	: Agent(PT_TCP),
      ...
      lldct_(false), lldct_w_min_(0.125), lldct_w_max_(2.5), lldct_size_min_(200*1024), lldct_size_max_(1024*1024),    fl_bndr_timer(this)
{
...
TcpAgent::delay_bind_init_all()
{
	...
	// Mohammad
// DCTCP
	delay_bind_init_one("dctcp_"); //khaliq
	delay_bind_init_one("dctcp_alpha_");//khaliq
	delay_bind_init_one("temp_alpha_");//khaliq
	delay_bind_init_one("dctcp_g_");//khaliq
